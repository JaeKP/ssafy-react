...
const headline = h('h1', null, 'Imperative Programming');
...
const app = h('div', { id: 'app' }, contents, button);

/* rendering react application ---------------------------------------------- */

const container = document.getElementById('root');
const reactDomRoot = createRoot(container);
reactDomRoot.render(h(StrictMode, null, app));
